...
class AppRuntime:
    ...
    def plugin_manager(self) -> Any:
        return self.skill_manager.plugin_manager

    @property
    def skill_registry(self) -> Any:
        return self.skill_manager.registry

    def refresh_skills(self) -> Any:
        return self.skill_manager.refresh()

    def plugin_status(self) -> tuple[list[Any], list[Any]]:
        return self.skill_manager.plugin_status()

    def set_plugin_enabled(self, name: str, enabled: bool) -> bool:
        return self.skill_manager.set_plugin_enabled(name, enabled)

    def build_skill_context(self, name: str, base: Any, *, arguments: str) -> Any:
        return self.skill_manager.build_context(name, base, arguments=arguments)

    def build_skill_context_for_definition(
        self,
        definition: Any,
        base: Any,
        *,
        ...
        return self.skill_manager.build_context_for_definition(definition, base, arguments=arguments)
    ...
    def select_auto_skill(
        ...
        *,
        ...
        return self.skill_manager.select_auto_skill(user_input, selector=selector, chat_fn=chat_fn)
    ...
    def prepare_agent_run(
        ...
        *,
        ...
        return self.session_runtime.prepare_agent_run(
            session,
            agent,
            context_builder,
            chat_fn=chat_fn,
    ...
    def compact_agent_session(
        ...
        *,
        ...
        return self.session_runtime.compact_agent_session(session, agent, chat_fn=chat_fn)
